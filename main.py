# 1. without changing name of course, how to access variable from base class which has same name as the variable in sub-class
# --------------------------------------------------------------------------------------------------------------------------
# --> using name mangling 
# --> using super().name -> to access base class variable name inside sub-class(when both variable have same name)
...
course = Course("python",4,"bob",31,21,"Gachibowli","jntu",['MCA','MBA'])
